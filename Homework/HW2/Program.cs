...
namespace HW2
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("This program processes a checkout system with the following features:");
            Console.WriteLine("1. Loads item prices from prices.txt");
            Console.WriteLine("2. Calculates subtotal and analyzes price data");
            Console.WriteLine("3. Applies a loyalty adjustment based on customer ID");
            Console.WriteLine("4. Converts the total to a foreign currency of your choice");
            Console.WriteLine("5. Optionally applies a surcharge percentage\n");
        ...
        static void DisplaySummary(double subtotal, double adjusted, double finalAmt)
        {
            ...
            Console.WriteLine("\n=== FINAL SUMMARY ===");
            Console.WriteLine($"Original Subtotal (USD): ${subtotal:0.00}");
            Console.WriteLine($"After Loyalty Adjustment (USD): ${adjusted:0.00}");
            Console.WriteLine($"Final Amount (Foreign Currency): {finalAmt:0.00}");
            Console.WriteLine("=====================\n");
        }
